...
convergence_AP_list = zeros(4,30);
for AP_num = 3:6
...
V_sum = sum(V_result);
convergence_AP_list(AP_num-2,t) = V_sum
...
% 画图
y_index = 0:1:30;
x_q_10 = convergence_AP_list(1,:);
x_q_50 = convergence_AP_list(2,:);
x_q_100 = convergence_AP_list(3,:);
x_q_200 = convergence_AP_list(4,:);
